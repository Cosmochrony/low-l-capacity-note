...
($\ell_2/\ell_1\simeq1.633$).

\section{Conclusion}
\label{sec:conclusion}

This note establishes four things.
First, the $8/3$ fibre-to-base stiffness ratio is a geometric invariant of the $S^3$ Hopf fibre
...
Second, the correct low-rank mechanism is a small absolute number of distinguishable histories
($3$, $7$, $17$: the exact Pell count), not a vanishing early growth rate.
Third, this mechanism converts into parameter-free suppression envelopes which, anchored only at
...
Fourth, the claim is bounded: the $\chi^2$ values are diagnostics rather than a likelihood
analysis, and the entropy-to-power step together with the polarization transfer treatment are the
named open items.
